...
class SnowflakeSettings:
    ...
    database: str = field(default_factory=lambda: os.getenv("SNOWFLAKE_DATABASE", "AGENTIC_PLATFORM"))
    ...
    def __post_init__(self):
        ...
        self.orchestrator_schema = os.getenv("SNOWFLAKE_ORCHESTRATOR_SCHEMA", self.orchestrator_schema)
    ...
    def from_use_case_config(cls, config: Dict[str, Any]) -> "SnowflakeSettings":
        ...
        return cls(
            database=snowflake_config.get("database", os.getenv("SNOWFLAKE_DATABASE", "AGENTIC_PLATFORM")),
...
_settings: Optional[SnowflakeSettings] = None
