...
class PipelineOrchestrator:
    ...
    def run_phase_1_discovery(self):
        ...
        print(f"   ML: {parsed.ml_enabled}, Search: {parsed.search_enabled}, Analytics: {parsed.analytics_enabled}")
    ...
    def run_phase_3_ml_training(self):
        ...
        df = pd.DataFrame(cursor.fetchall(), columns=["ROP", "WOB", "HOOKLOAD", "TORQUE", "PRESSURE", "RPM", "DEPTH", "IS_STUCK"])
        cursor.close()
        conn.close()
        ...
        self.artifacts["ml_model"] = {"ref": model_ref, "version": version, "accuracy": accuracy, "f1": f1}
        return True
    ...
    def run_phase_5_semantic_model(self):
        ...
        output_path = os.path.join(
            ...
            "config", "semantic_models", "orchestrated_drilling_model.yaml"
        )
    ...
    def run_phase_6_validation(self):
        ...
        required = ["parsed_requirements", "execution_plan", "ml_model", "search_service", "semantic_model"]
