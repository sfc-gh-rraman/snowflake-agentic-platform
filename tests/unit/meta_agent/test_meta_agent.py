...
class TestMetaAgentState:
    ...
    def test_state_has_required_fields(self):
        ...
        required_fields = [
            "use_case_description", "data_locations", "data_assets",
            "parsed_requirements", "data_profile", "available_agents",
            "execution_plan", "approval_status", "current_phase",
        ]
...
class TestAgentRegistryQuery:
    ...
    def test_registry_query_finds_agents(self, sample_agent_registry_entries, mock_snowflake_connector):
...
class TestMetaAgentGraph:
    ...
    def test_graph_has_correct_flow(self):
        ...
        expected_nodes = [
            "parse_use_case", "scan_data", "query_registry",
            "generate_plan", "human_approval", "execute_plan"
        ]
